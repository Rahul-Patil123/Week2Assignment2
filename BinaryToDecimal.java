 ...
 * Date : 12/09/2024
 * Description : [Make a program that converts binary number (without decimals) into decimal(base 10) number ]
 */
...
public class BinaryToDecimal {
    ...
    //To decimal function is used to print decimal of any binary number except ( . )
